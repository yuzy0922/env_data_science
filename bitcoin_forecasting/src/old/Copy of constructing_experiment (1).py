...
def viz_results(df, DV_colname, ModelPred_series, y_test_preprocessed, test_ModelAccuracies, test_RandomAccuracies, test_NaiveAccuracies, test_AlgoReturns, test_RandomReturns, test_NaiveReturns, test_BuyAndHolds, new_folder, model_name, finished_time):
    ...
    print("Average of naive-forecasting scores on test", np.mean(test_NaiveAccuracies))

    # Calculate the average of total returns on each CV
    print("Average of total Algo return on test", np.mean(test_AlgoReturns))
    print("Average of total Random return on test", np.mean(test_RandomReturns))
    print("Average of total Naive forecasting return on test", np.mean(test_NaiveReturns))
    ...
    ax3.plot(test_ModelAccuracies, label="ModelPred")
    ax3.plot(test_RandomAccuracies, label="RandomPred")
    ax3.plot(test_NaiveAccuracies, label="NaivePred")
    ax3.set_title("Forecasting Accuracies on each CV")
    ax3.set_xlabel("Times of Cross Validation")
    ax3.set_xticks([item for item in range(0, len(test_ModelAccuracies)+1)])
    ax3.set_ylabel("Forecasting Accuracies")
    ax3.grid(True)
    ax3.legend()
    
#    # Histgram
#    ax4.hist(test_ModelAccuracies, bins=6, label="ModelPred", alpha=0.3)
#    ax4.hist(test_RandomAccuracies, bins=6, label="RandomPred", alpha=0.3)
...
#    ax4.legend()
    # Density Plot
    sns.distplot(test_ModelAccuracies, hist=False, kde=True, hist_kws={'edgecolor':'black'},kde_kws={'linewidth': 2}, ax=ax4)
    sns.distplot(test_RandomAccuracies, hist=False, kde=True, hist_kws={'edgecolor':'black'},kde_kws={'linewidth': 2}, ax=ax4)
    sns.distplot(test_NaiveAccuracies, hist=False, kde=True, hist_kws={'edgecolor':'black'},kde_kws={'linewidth': 2}, ax=ax4)
    ...
    ax5.plot(test_AlgoReturns, label="ModelPred")
    ax5.plot(test_RandomReturns, label="RandomPred")
    ax5.plot(test_NaiveReturns, label="NaivePred")
    ax5.plot(test_BuyAndHolds, label="Buy-and-Hold")    
    ax5.set_title("Total Returns on each CV")
    ax5.set_xlabel("Times of Cross Validation")
    ax5.set_xticks([item for item in range(0, len(test_AlgoReturns)+1)])
    ax5.set_ylabel("Total Returns")
    ax5.grid(True)
    ax5.legend()
    
    # Density Plot
    sns.distplot(test_AlgoReturns, hist=False, kde=True, hist_kws={'edgecolor':'black'},kde_kws={'linewidth': 2}, ax=ax6)
    sns.distplot(test_RandomReturns, hist=False, kde=True, hist_kws={'edgecolor':'black'},kde_kws={'linewidth': 2}, ax=ax6)
    sns.distplot(test_NaiveReturns, hist=False, kde=True, hist_kws={'edgecolor':'black'},kde_kws={'linewidth': 2}, ax=ax6)
    sns.distplot(test_BuyAndHolds, hist=False, kde=True, hist_kws={'edgecolor':'black'},kde_kws={'linewidth': 2}, ax=ax6)
...
def save_figs(df, DV_colname, ModelPred_series, y_test_preprocessed, test_ModelAccuracies, test_RandomAccuracies, test_NaiveAccuracies, test_AlgoReturns, test_RandomReturns, test_NaiveReturns, test_BuyAndHolds, new_folder, model_name, finished_time):
    """
    ...
    # ax3
    plt.figure(figsize=(12,8))
    plt.plot(test_ModelAccuracies, label="ModelPred")
    plt.plot(test_RandomAccuracies, label="RandomPred")
    plt.plot(test_NaiveAccuracies, label="NaivePred")
    plt.title("Forecasting Accuracies on each CV")
    plt.xlabel("Times of Cross Validation")
    plt.xticks([item for item in range(0, len(test_ModelAccuracies)+1)])
...
#    plt.savefig(new_folder+"/"+model_name+"_"+finished_time+"_"+"dist_accuracy"+".png", format="png", dpi=400);
      # Density Plot
    plt.figure(figsize=(12,8))
    sns.distplot(test_ModelAccuracies, hist=False, kde=True, hist_kws={'edgecolor':'black'},kde_kws={'linewidth': 2})
    sns.distplot(test_RandomAccuracies, hist=False, kde=True, hist_kws={'edgecolor':'black'},kde_kws={'linewidth': 2})
    sns.distplot(test_NaiveAccuracies, hist=False, kde=True, hist_kws={'edgecolor':'black'},kde_kws={'linewidth': 2})
    ...
    # ax5
    plt.figure(figsize=(12,8))
    plt.plot(test_AlgoReturns, label="ModelPred")
    plt.plot(test_RandomReturns, label="RandomPred")
    plt.plot(test_NaiveReturns, label="NaivePred")
    plt.plot(test_BuyAndHolds, label="Buy-and-Hold")
    plt.title("Total Returns on each CV")
    plt.xlabel("Times of Cross Validation")
    plt.xticks([item for item in range(0, len(test_AlgoReturns)+1)])
    ...
    # ax6
      # Density Plot
    plt.figure(figsize=(12,8))
    sns.distplot(test_AlgoReturns, hist=False, kde=True, hist_kws={'edgecolor':'black'},kde_kws={'linewidth': 2})
    sns.distplot(test_RandomReturns, hist=False, kde=True, hist_kws={'edgecolor':'black'},kde_kws={'linewidth': 2})
    sns.distplot(test_NaiveReturns, hist=False, kde=True, hist_kws={'edgecolor':'black'},kde_kws={'linewidth': 2})
    sns.distplot(test_BuyAndHolds, hist=False, kde=True, hist_kws={'edgecolor':'black'},kde_kws={'linewidth': 2})
...
# Execute rwcv_c
def rwcv_c(df, model_name, modelling, DV_colname="btc_LogReturn_binary", DV_shifts=1, IV_lags=2, n_train_days=480, n_valid_days=60, n_test_days=60, metric=f1_score, feature_importances=False):
    """
    ...
    df_output = pd.DataFrame({"CV": counts, "test_start": test_starts, "test_end": test_ends, "model": [model_name]*len(counts), "best_params": list_best_params, "vars_set": [X_train_valid.columns]*len(counts),
                              # Forecasting Scores
    ...
    df_average = pd.DataFrame({"CV": ["Average"], "test_start": [test_starts[0]], "test_end": [test_ends[-1]], "model": [model_name], "best_params": [np.nan], "vars_set": [X_train_valid.columns], 
                              # Forecasting Scores
    ...
    df_output = pd.concat([df_output, df_average], axis=0)
    ...
    df_output.to_csv(path+"/07_model_output/result_table/"+model_name+"_"+finished_time+"_results_table.csv")
    ...
    viz_results(df, DV_colname, ModelPred_series, y_test_preprocessed, test_ModelAccuracies, test_RandomAccuracies, test_NaiveAccuracies, test_AlgoReturns, test_RandomReturns, test_NaiveReturns, test_BuyAndHolds, new_folder, model_name, finished_time)
    
    # Save all figures individually
    save_figs(df, DV_colname, ModelPred_series, y_test_preprocessed, test_ModelAccuracies, test_RandomAccuracies, test_NaiveAccuracies, test_AlgoReturns, test_RandomReturns, test_NaiveReturns, test_BuyAndHolds, new_folder, model_name, finished_time)
